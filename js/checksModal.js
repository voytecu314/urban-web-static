document.getElementById('triggerChecksModal').addEventListener('click', runChecksModalLogic);

function runChecksModalLogic () {
            ...
            document.getElementById('add-files-btn').addEventListener('click', (e) => {
                    ...
                    const fileInput = 
                        `<div class="d-flex">
                            <input type="file" name="customer-file-${uuid}" id="customer-file-${uuid}"  class="form-control" accept="audio/*,video/*,image/*">
            ...
            const paletteSelector = document.getElementById('select-palette');
            const palettes = {
